    ...
    <div className="min-h-screen bg-black p-8">
      <div className="max-w-7xl mx-auto space-y-10">
        <div className="space-y-2">
          <h1 className="text-5xl font-bold text-white tracking-tight">Welcome back, {user.name || user.email}!</h1>
          <p className="text-white/60 text-lg">Here's your SkillSync overview</p>
        </div>
        ...
        <Card>
          ...
          <CardContent className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Link href="/documents" className="block">
              <Button className="w-full h-28 text-base">
                <div className="flex flex-col items-center gap-2">
                  <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" />
                  </svg>
                  <span>Upload New Coursework</span>
                </div>
              </Button>
            </Link>
            <Link href="/skills" className="block">
              <Button className="w-full h-28 text-base" variant="secondary">
                <div className="flex flex-col items-center gap-2">
                  <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-white/60 text-center py-8">No recent activity yet. Start by uploading your first document!</p>
          </CardContent>
        </Card>
      </div>
    </div>
