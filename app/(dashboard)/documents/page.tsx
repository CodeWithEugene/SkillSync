...
const sampleDocuments: Document[] = [
  {
    id: 'sample-1',
    filename: '3.2 2024 Exams and CATs.pdf',
    fileUrl: '#',
    status: 'PROCESSING',
    uploadDate: new Date('2025-12-06').toISOString(),
  },
  {
    id: 'sample-2',
    filename: '3.2 2024 Exams and CATs.pdf',
  ...
  {
    id: 'sample-3',
    filename: 'sacco PRD (1).pdf',
    fileUrl: '#',
    status: 'PROCESSING',
    uploadDate: new Date('2025-11-18').toISOString(),
  },
  {
    id: 'sample-4',
    filename: 'Adamur_UI_System.fig',
    fileUrl: '#',
    status: 'COMPLETED',
    uploadDate: new Date('2025-10-22').toISOString(),
  },
  {
    id: 'sample-5',
    filename: 'CyberUhuru_Dashboard_Audit.pdf',
    fileUrl: '#',
    status: 'COMPLETED',
    uploadDate: new Date('2025-09-30').toISOString(),
  },
  {
    id: 'sample-6',
  ...
  {
    id: 'sample-7',
    filename: 'Technetium_Kenya_Growth_Plan.pdf',
    fileUrl: '#',
    status: 'PROCESSING',
  ...
  {
    id: 'sample-8',
    filename: 'OneHope_ReactNative_ReleaseNotes.pdf',
    fileUrl: '#',
    status: 'COMPLETED',
